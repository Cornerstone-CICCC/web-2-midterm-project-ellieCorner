  ...
  ({
    ...
    return (
      <section className="relative h-[70vh] sm:h-[80vh] overflow-hidden">
              ...
              <div className="absolute bottom-4 sm:bottom-16 left-0 right-0 p-4 sm:p-8 z-20">
                <div className="container mx-auto max-w-2xl">
                  <div className="flex flex-wrap items-center space-x-2 sm:space-x-3 mb-2 sm:mb-4 text-xs sm:text-sm">
                    <span className="flex items-center space-x-1 bg-red-600 px-2 py-1 rounded-full font-bold text-white dark:text-white">
                  ...
                  <div className="flex flex-wrap items-center space-x-2 sm:space-x-4">
                    <button
                      ...
                      className="flex items-center space-x-2 sm:space-x-3 
                        ...
                        px-4 py-2 sm:px-8 sm:py-4 rounded-full font-bold text-sm sm:text-lg 
                    ...
                    <button
                      ...
                      className={`flex items-center space-x-1 sm:space-x-2 px-3 py-2 sm:px-6 sm:py-4 rounded-full font-bold text-sm sm:text-base transition-all hover:scale-105 ${
                        favorites.includes(movie.id)
                          ...
                          : "bg-white/20 dark:bg-black/20 backdrop-blur-sm text-white dark:text-gray-900 hover:bg-red-500 hover:text-white"
                      }`}
                    >
                      <Heart
        ...
        <button
          onClick={prevSlide}
          className="absolute top-1/2 left-2 sm:left-4 transform -translate-y-1/2 z-30 p-2 sm:p-3 
            bg-black/50 dark:bg-white/50 backdrop-blur-sm 
            rounded-full text-white dark:text-black hover:bg-black/70 dark:hover:bg-white/70 
        ...
        <button
          onClick={nextSlide}
          className="absolute top-1/2 right-2 sm:right-4 transform -translate-y-1/2 z-30 p-2 sm:p-3 
            bg-black/50 dark:bg-white/50 backdrop-blur-sm 
            rounded-full text-white dark:text-black hover:bg-black/70 dark:hover:bg-white/70 
            transition-all hover:scale-110"
        >
          ...
          <button
            ...
            className={`flex items-center space-x-1 sm:space-x-2 px-2 sm:px-4 py-1 sm:py-2 rounded-full font-semibold text-xs sm:text-sm transition-all ${
              isAutoPlay
                ...
                : "bg-white/20 dark:bg-black/20 backdrop-blur-sm text-white dark:text-gray-900 hover:bg-white/30 dark:hover:bg-black/30"
            }`}
          >
