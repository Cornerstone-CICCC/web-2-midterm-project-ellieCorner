...
export const About = () => (
  <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white p-4 md:p-12">
    <div className="max-w-5xl mx-auto space-y-12">
      ...
      <section className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-10 space-y-4">
      ...
      <section className="bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-10 space-y-6">
        <h2 className="text-2xl font-semibold flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[{ name: "Ellie", role: "Frontend" }].map((member) => (
            <div
              key={member.name}
              className="bg-white/10 rounded-xl p-4 flex flex-col items-center transition-transform hover:scale-105"
            >
      ...
      <section className="text-center">
        <a
          ...
          className="inline-flex items-center space-x-2 bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-full transition-all hover:scale-105 font-semibold"
        >
